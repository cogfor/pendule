        ...
        carousel.prototype = {
              ...
              //  try {
                    ...
                    if (1==2&&endPos > 0) {
                        ...
                        if(this.wrap){
                            ...
                            if (currInd > (this.childrenCount - 1)) {
                                // console.log('1 -' ,this.childrenCount - 1);
                                toMove =  this.childrenCount - 1;
                            }
                            if (currInd < 0) {
                                toMove = 0;
                            }
            ...
            onMoveIndex: function(newInd,transitionTime) {
                ...
                var runFinal = false;
                    ...
                    //alert(this.carouselIndex);
                    //alert(this.childrenCount);
            ...
            moveCSS3: function(el, distanceToMove, time, timingFunction) {
                ...
                var cal = this.childrenCount / 2.5 ;
                var mul = cal * numOnly(this.container.clientWidth);
                if(Math.abs(distanceToMove.x) > mul ) {
                    var dis = -Math.abs(mul);
                }
                else{
                  var dis = distanceToMove.x;
                }
                // console.log(Math.abs(distanceToMove.x));
                el.style[$.feat.cssPrefix+"Transform"] = "translate" + translateOpen + dis + "px," + distanceToMove.y + "px" + translateClose;
            ...
            refreshItems: function() {
                ...
                for (var i = 0; i < elems.length; i++) {
                    if (this.horizontal) {
                        ...
                        //elems[i].style['text-align']="center";
                    }
                    else {
                ...
                if (this.horizontal) {
                    el.style.width = Math.ceil((this.childrenCount) * 41.5) + "%";
